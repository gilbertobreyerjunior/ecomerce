            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="table table-striped">
                        ...
                        <!-- Aqui ira mostrar todos os produtos que não estão relacionados com a categoria -->
                        <tbody>
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <table class="table table-striped">
                        ...
                        <!-- Aqui ira mostrar todos os produtos que estão relacionados com a categoria -->
                        <tbody>
