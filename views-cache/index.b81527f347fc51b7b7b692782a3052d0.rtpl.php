...
<!-- Iremos fazer o loop do raintpl -->
    <?php $counter1=-1;  if( isset($products) && ( is_array($products) || $products instanceof Traversable ) && sizeof($products) ) foreach( $products as $key1 => $value1 ){ $counter1++; ?> 
                    <div class="single-product">
                        <div class="product-f-image">
                            <!-- aqui iremos mostrar os dados do produto iremos acessar a o atrib value que e criado dentro de um loop  -->
                        ...
                        <div class="product-carousel-price"> 
                                <!-- o $value e o . vlprice sao passados como argumentos da minha funcao format price e ira retornar o meu valor formatado    -->
